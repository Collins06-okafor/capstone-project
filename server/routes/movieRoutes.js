...
router.post('/', auth, async (req, res) => {
    ...
    try {
        const result = await pool.query(
            'INSERT INTO movies (title, description, genre, release_date, poster_url, duration_min) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *',
...
router.put('/:id', auth, async (req, res) => {
    ...
    try {
        const result = await pool.query(
            'UPDATE movies SET title=$1, genre=$2, description=$3, duration_min=$4, poster_url=$5 WHERE id=$6 RETURNING *',
